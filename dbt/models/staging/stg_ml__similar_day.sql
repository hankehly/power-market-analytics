...
select
  ...
  cast(null as double) as similar_day_rank1_demand_kwh,
  cast(null as double) as similar_day_rank2_demand_kwh,
  cast(null as double) as similar_day_rank3_demand_kwh,
  cast(null as double) as wavg_similar_day_top3_demand_kwh,
  cast(null as date) as similar_day_rank1_reference_date,
  cast(null as date) as similar_day_rank2_reference_date,
  cast(null as date) as similar_day_rank3_reference_date,
  cast(null as double) as similar_day_rank1_distance,
  cast(null as double) as similar_day_rank2_distance,
  cast(null as double) as similar_day_rank3_distance,
  cast(null as int) as similar_day_n_candidates,
  cast(null as double) as similar_day_pool_rank1_demand_kwh,
  cast(null as double) as similar_day_pool_rank2_demand_kwh,
  cast(null as double) as similar_day_pool_rank3_demand_kwh,
  cast(null as double) as wavg_similar_day_pool_top3_demand_kwh,
  cast(null as date) as similar_day_pool_rank1_reference_date,
  cast(null as date) as similar_day_pool_rank2_reference_date,
  cast(null as date) as similar_day_pool_rank3_reference_date,
  cast(null as double) as similar_day_pool_rank1_distance,
  cast(null as double) as similar_day_pool_rank2_distance,
  cast(null as double) as similar_day_pool_rank3_distance,
  cast(null as int) as similar_day_pool_n_candidates,
  cast(null as timestamp) as similar_day_pool_fit_cutoff,
  cast(null as timestamp) as similar_day_fit_cutoff,
  cast(null as string) as similar_day_method,
