...
with
  ...
  select
    ...
    stack(
      ...
      'similar_day_pool_rank1_demand_kwh', cast(m.similar_day_pool_rank1_demand_kwh as double), false,
      'similar_day_pool_rank2_demand_kwh', cast(m.similar_day_pool_rank2_demand_kwh as double), false,
