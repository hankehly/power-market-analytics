...
| Date | Work | Spec | Plan |
|---|---|---|---|
| 2026-09-19 | Feature candidate #148, for review — Kaufman's adaptive average of the same-period demand; measured first: on consecutive days the weekly cycle reads as noise, so it sits near its slow end | [spec](superpowers/specs/2026-09-19-candidate-148-kama-adaptive-load-level-design.md) | Not built |
| 2026-09-19 | Feature candidate #134, for review — the observed temperature of the load reference days and D's forecast minus it, in three marts over a new curated area-hour fact | [spec](superpowers/specs/2026-09-19-candidate-134-weather-differences-from-load-references-design.md) | Not built |
| 2026-09-19 | Feature candidate #133, for review — the MSM forecast for D-1 from D's own run; the leads are in a file already fetched every day, so the cost is the backfill alone | [spec](superpowers/specs/2026-09-19-candidate-133-msm-forecast-for-the-day-before-design.md) | Not built |
