...
| 2026-09-19 | Feature candidate #151 — the forecast morning temperature trend in `ftr_day_msm`, over differences, and the cumulative forecast solar radiation in `ftr_hour_msm`, added after the researcher corrected the reason for leaving it out | [spec](superpowers/specs/2026-09-19-candidate-151-forecast-weather-trajectory-design.md) | — |
