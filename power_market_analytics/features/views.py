...
FTR_PERIOD_SIMILAR_DAY_SOURCE = SparkSource(
    ...
    query="select area_code, cast(date_format(trade_date, 'yyyyMMdd') as int) as trade_date_key, time_code, similar_day_rank1_demand_kwh, similar_day_rank2_demand_kwh, similar_day_rank3_demand_kwh, wavg_similar_day_top3_demand_kwh, similar_day_rank1_distance, similar_day_rank1_lag_days, available_at, published_at from pma_features.ftr_period_similar_day",
    timestamp_field="available_at",
