...
FTR_PERIOD_SIMILAR_DAY = FeatureView(
    ...
    schema=[
        Field(
            ...
            tags={"categorical": "false", "expression": "SIMILAR_DAY(power_usage_demand_kwh, gap=(2d, 335d), window=(30, 60), rank=1, holidays=same_holiday) / 2"},
        ),
        Field(
            ...
            tags={"categorical": "false", "expression": "SIMILAR_DAY(power_usage_demand_kwh, gap=(2d, 335d), window=(30, 60), rank=2, holidays=same_holiday) / 2"},
        ),
        Field(
            ...
            tags={"categorical": "false", "expression": "SIMILAR_DAY(power_usage_demand_kwh, gap=(2d, 335d), window=(30, 60), rank=3, holidays=same_holiday) / 2"},
        ),
        Field(
            ...
            tags={"categorical": "false", "expression": "SIMILAR_DAY_MEAN(power_usage_demand_kwh, gap=(2d, 335d), window=(30, 60), k=3, weight=inverse_distance, holidays=same_holiday) / 2"},
        ),
        Field(
            name="similar_day_rank1_distance",
            dtype=Float64,
            description="Rank 1's distance from D under the run's weights: how good the match is, smaller is closer. Null on a same-holiday day, which is not ranked and has no distance (7 % of Tokyo's days). A feature since 2026-09-19 (feature candidate #138).",
            tags={"categorical": "false", "expression": "similar_day_rank1_distance"},
        ),
        Field(
            name="similar_day_rank1_lag_days",
            dtype=Int64,
            description="The days from the rank-1 day to D: trade_date minus similar_day_rank1_reference_date (feature candidate #138). On a ranked day it falls in one of the pool's two windows, 2 to 31 or 335 to 394, and nowhere between; on a same-holiday day it is the days back to the same holiday last year.",
            tags={"categorical": "false", "expression": "similar_day_rank1_lag_days"},
        ),
        Field(
            name="similar_day_pool_rank1_demand_kwh",
            dtype=Float64,
            description="The nearest pool day's hourly load (fct_area_power_usage_hourly, kWh over the hour containing the period) halved, kWh per 30-minute period. Unlike similar_day_rank1_demand_kwh this is the ranking on every day, a same-holiday day included, so a preset picks between copying last year's same holiday and ranking every day (experiment #219). Null where the pool had no candidate.",
            tags={"categorical": "false", "expression": "SIMILAR_DAY(power_usage_demand_kwh, gap=(2d, 335d), window=(30, 60), rank=1, holidays=similarity) / 2"},
        ),
        Field(
            name="similar_day_pool_rank2_demand_kwh",
            dtype=Float64,
            description="The second nearest pool day's hourly load (fct_area_power_usage_hourly, kWh over the hour containing the period) halved, kWh per 30-minute period. Unlike similar_day_rank2_demand_kwh this is the ranking on every day, a same-holiday day included, so a preset picks between copying last year's same holiday and ranking every day (experiment #219). Null where the pool had no candidate. Null when the pool has fewer than two days.",
            tags={"categorical": "false", "expression": "SIMILAR_DAY(power_usage_demand_kwh, gap=(2d, 335d), window=(30, 60), rank=2, holidays=similarity) / 2"},
        ),
        Field(
            name="similar_day_pool_rank3_demand_kwh",
            dtype=Float64,
            description="The third nearest pool day's hourly load (fct_area_power_usage_hourly, kWh over the hour containing the period) halved, kWh per 30-minute period. Unlike similar_day_rank3_demand_kwh this is the ranking on every day, a same-holiday day included, so a preset picks between copying last year's same holiday and ranking every day (experiment #219). Null where the pool had no candidate. Null when the pool has fewer than three days.",
            tags={"categorical": "false", "expression": "SIMILAR_DAY(power_usage_demand_kwh, gap=(2d, 335d), window=(30, 60), rank=3, holidays=similarity) / 2"},
        ),
        Field(
            name="wavg_similar_day_pool_top3_demand_kwh",
            dtype=Float64,
            description="The mean of the pool rank loads present, weighted by inverse distance by the rule of wavg_similar_day_top3_demand_kwh, kWh per 30-minute period. The ranking on every day, a same-holiday day included. Null where the pool had no candidate.",
            tags={"categorical": "false", "expression": "SIMILAR_DAY_MEAN(power_usage_demand_kwh, gap=(2d, 335d), window=(30, 60), k=3, weight=inverse_distance, holidays=similarity) / 2"},
        ),
        Field(
            name="similar_day_pool_rank1_distance",
            dtype=Float64,
            description="The pool ranking's rank-1 distance from D under the run's fitted weights. Unlike similar_day_rank1_distance it is filled on a same-holiday day.",
            tags={"categorical": "false", "expression": "similar_day_pool_rank1_distance"},
        ),
        Field(
            name="similar_day_pool_rank1_lag_days",
            dtype=Int64,
